...
<div class="conteneur">
  ...
  <main>
    <div class="bloc-section">
      ...
      if (
        in_array($_SESSION['typeUser'], ['benevole', 'salarie'])
      ...
      <?php else: ?>
        ...
        <?php if ($_SESSION['typeUser'] === 'rh' && isset($SelectedBody)): ?>
          <div class="bloc-info">
            ...
            <!-- : bouton Suppression définitive mais ne fonctionne pas, a voir dans la prochaine version -->
            <form method="post" action="index.php?m2lMP=demandes"
              onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette demande ? Cette action est irréversible.');">
              <input type="submit"
                name="btnSupprimerDemandeRh"
                value="Supprimer la demande"
                class="btn-supprimer" />
            </form>
          </div>
        <?php endif; ?>
